...
/**
 * Esta clase es la principal que se encarga de abrir el fichero y llamar a
 * countInversions.
 */
public class Main {
	static double[] b;
	...
	/**
	 * Este es el método principal donde se llamará al método openFile() para
	 * extraer los datos del fichero y almacenarlos en un array global b.
	 * Posteriormente, se imprimirá por pantalla el resultado de llamar al método
	 * countInversions(b, 0, b.length - 1) situado en la clase Metodos.java.
	 */
	public static void main(String[] args) {
		openFile();
		System.out.println("El número de inversiones usando el patrón divide y vencerás es "
				+ Metodos.countInversions(b, 0, b.length - 1) + ".");
	}
