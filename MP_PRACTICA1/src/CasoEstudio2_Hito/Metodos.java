...
public class Metodos {
	...
	/**
	 * Este método realiza una llamada recursiva a sí misma donde se va dividiendo
	 * el array por la mitad hasta que solo quede un elemento en el mismo. Una vez
	 * tenemos todos los elementos separados procedemos a ordenarlos a través del
	 * método mergeandCount, donde se contará el número de inversiones.
	 *
	 * @param a      Array de números que se va a ordenar.
	 * @param left   Índice del primer elemento del primer subarray que se está
	 *               fusionando.
	 * @param middle Índice del último elemento del primer subarray que se está
	 *               fusionando.
	 * @param right  Índice del último elemento del segundo subarray que se está
	 *               fusionando.
	 ...
	 * nuestro algoritmo tendrá una recurrencia del orden O(n^d*log n) => O(n^1*log
	 * n) =O(n log n)
	 * 
	 * 
	 *
